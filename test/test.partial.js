...
describe( 'partial quantile', function tests() {
	...
	it( 'should partially apply the quantile function of the F distribution for given parameter values', function test() {
		var quantile;
		quantile = partial( d1, d2 );
